...
const Sidebar = () => {
  return (
    <div className="h-[calc(100vh-5.5rem)] sticky top-16     lg:px-6 box-border flex justify-start items-start w-[22rem] overflow-y-auto  pt-12 thin-right-divider ">
      {/*sidebar content */}
      <nav className="relative h-full w-full px-[0rem]">
        ...
        <div className="  h-full w-full text-left flex items-center flex-col justify-start  font-inter space-y-4">
          <div className="w-full box-border space-y-1">
