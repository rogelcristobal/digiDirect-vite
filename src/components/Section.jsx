...
const Section = ({
  ...
  return (
    ...
    >
      {category &&  (
        <p
          className="text-sm leading-[24px] capitalize  font-inter tracking-tight font-[600] mb-3 text-[#0055ff]"
        >
          {category}
        </p>
      )}
      <h2
        href={hash} //category
        className={`text-neutral-800 font-plus  capitalize tracking-tight font-[600] mb-3   max-w-2xl
        ${header ? "text-3xl" : child ? "text-lg" : "text-[1.3rem]"}`}
      >
        {title}
